...
class CarBrand {
  ...
  static CarBrand snapshotFromMap(AsyncSnapshot<DocumentSnapshot> snapshot) {
    Map<String, dynamic> data = snapshot.data!.data() as Map<String, dynamic>;

    return CarBrand.basicFromMap(data);
  }

  static List<CarBrand> toList(List jsonData){
    List<CarBrand> carBrands = [];
    for(dynamic data in jsonData){
      carBrands.add(CarBrand.basicFromMap(data));
    }
    return carBrands;
  }

  static List<CarBrand> snapshotToList(AsyncSnapshot<QuerySnapshot> snapshot) {
