...
class _SignInState extends State<SignIn> {
  ...
  Widget build(BuildContext context) {
    ...
    AuthProvider authProviderS = Provider.of<AuthProvider>(context);
    return Scaffold(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              authProviderS.authStatus == AuthStatus.Authentificating
              ...
              InkWell(
                onTap: () {
                  ...
                  print("Voici l'état actuel : ${authProviderS.authStatus}");
                  if (authProviderS.authStatus == AuthStatus.LoggedIn) {
